...
export const metadata: Metadata = {
  title: "O biurze – Biuro Rachunkowe DPZ",
  description:
    "Poznaj nasze biuro rachunkowe – profesjonalizm, zaufanie i doświadczenie.",
};
...
export default function About() {
  return (
    <>
      <Head>
        <title>O biurze – Biuro Rachunkowe Diana Pamela Zapadka</title>
        <meta
          name="description"
          content="Poznaj nasze biuro rachunkowe DPZ – doświadczenie, zaufanie i profesjonalizm w obsłudze firm z całej Polski."
        />
        <meta property="og:title" content="O biurze – Biuro Rachunkowe DPZ" />
        <meta
          property="og:description"
          content="Poznaj nasze biuro rachunkowe DPZ – doświadczenie, zaufanie i profesjonalizm w obsłudze firm z całej Polski."
        />
        <meta property="og:image" content="/images/poznajmnie.jpg" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.biurodpz.pl/about" />
      </Head>
      <main className={styles.biuro}>
        {/* Sekcja 1 - O mnie */}
            ...
            <div className={styles.aboutContent}>
              <div className={styles.textColumn}>
                <p>
                  ...
                  <br />
                  Moja przygoda z księgowością zaczęła się klasycznie – od
                  etatu. Po latach zdobywania doświadczenia i pogłębiania wiedzy
                ...
                <p>
                  ...
                  z jakimi mierzą się przedsiębiorcy – zarówno ci prowadzący
                  małe biznesy, jak i rozwijający większe przedsięwzięcia.
                </p>
              </div>
              ...
              <div className={styles.textColumn}>
                <p>
                  ...
                  powierzyć wszystkie kwestie podatkowe doświadczonemu
                  ekspertowi.
                </p>
                <p>
                  Zaufanie, rzetelność i indywidualne podejście to fundamenty,
                  na których opieram współpracę z klientami.{" "}
                  <strong>
                    Zapraszam do kontaktu – wspólnie sprawmy, by Twoja
                    księgowość stała się strategiczną przewagą Twojego biznesu!
                  </strong>
                </p>
              </div>
            </div>
          ...
          <div className={styles.photo}>
            ...
            <div className={styles.highlight}>
              ...
              <p>
                ...
                <strong>prawdziwe wyzwania przedsiębiorców</strong>. Dlatego w
                DPZ nie tylko rozliczamy podatki -{" "}
                <strong>
                  dbamy o bezpieczeństwo finansowe Twojego biznesu
                </strong>
                .
              </p>
            </div>
            ...
            <div className={styles.aboutContent}>
              <div className={styles.textColumn}>
                ...
                <p>
                  ...
                  sektorów pozwala nam precyzyjnie dostosować usługi do
              ...
              <div className={styles.textColumn}>
                <p>
                  W DPZ stale poszerzamy swoją wiedzę, uczestnicząc w
                  szkoleniach i na bieżąco śledząc zmiany przepisów.{" "}
                  <strong>
                    Dzięki temu możesz mieć pewność, że Twoja firma działa w
                    pełni zgodnie z prawem.
                  </strong>
                </p>
                <p>
